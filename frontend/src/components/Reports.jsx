...
export function Reports() {
  ...
  const handleExportPDF = () => {
    ...
    weeklyData.forEach(d => {
      const rowData = [
        ...
        formatCurrency(d.revenue / d.transactions)
      ];
  ...
  const handleExportExcel = () => {
    const data = weeklyData.map(d => ({
      ...
      "Rata-rata Pembelian/Trx (Rp)": Math.round(d.revenue / d.transactions)
    }));
  ...
  return (
    <div className="p-4 sm:p-8 space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-xl border border-orange-400 dark:border-orange-500/50 shadow-sm text-white relative overflow-hidden transition-colors duration-300">
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex items-center gap-1.5 text-orange-800 bg-orange-100/90 px-2 py-0.5 rounded text-sm font-bold shadow-sm backdrop-blur-sm">
              ...
              <span>+12.5%</span> 
              <span className="font-medium text-xs ml-1 opacity-80 uppercase">vs periode lalu</span>
            </div>
          </div>
        </div>

        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:border-blue-200 dark:hover:border-blue-600 transition-colors duration-300">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:border-purple-200 dark:hover:border-purple-600 transition-colors duration-300">
          <div className="flex items-start justify-between mb-2">
            <div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:border-green-200 dark:hover:border-green-600 transition-colors duration-300">
          <div className="flex items-start justify-between mb-2">
            <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={weeklyData} margin={{ top: 5, right: 30, left: 10, bottom: 5 }}>
              ...
              <Line
                ...
                stroke="#ea580c"
                strokeWidth={3}
                dot={{ fill: '#white', stroke: '#ea580c', strokeWidth: 2, r: 6 }}
        ...
        {/* Sales Chart */}
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-300">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Volume Detail Penjualan</h3>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={weeklyData} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
              ...
              <Tooltip
                ...
                cursor={{ fill: theme === 'dark' ? '#374151' : '#e0f2fe', opacity: 0.6 }}
              />
              <Bar dataKey="sales" name="Banyak Penjualan (Porsi)" fill="#3b82f6" radius={[6, 6, 0, 0]} barSize={40} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
              ...
              {weeklyData.map((day, index) => (
                <tr key={index} className="hover:bg-orange-50/30 dark:hover:bg-orange-900/10 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm font-medium text-gray-600 dark:text-gray-400 text-right">
                    <span className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded inline-block transition-colors">{formatCurrency(day.revenue / day.transactions)}</span>
                  </td>
                </tr>
              ))}
